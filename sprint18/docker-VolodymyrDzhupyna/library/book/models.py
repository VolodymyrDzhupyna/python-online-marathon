...
class Book(models.Model):
    ...
    """
    name = models.CharField(blank=True, max_length=128, verbose_name="Book title")
    description = models.CharField(blank=True, max_length=256)
    count = models.IntegerField(default=10, help_text="How many books left?")
    in_stock = models.BooleanField(default=True)
    year_of_publication = models.PositiveIntegerField(default=1970)
