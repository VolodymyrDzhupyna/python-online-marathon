...
class Book(models.Model):
    ...
    issue_date = models.DateField(default=timezone.now, verbose_name='Book issue date', editable=True, null=True)
    pub_year = models.DateField(default=timezone.now, editable=True, null=True, verbose_name='Year publication')
